...
const Butterfly = () => {
  ...
  const filteredGun = weapons.filter(weapon => weapon.weapon.name === "Butterfly Knife");
  ...
  return (
    <>
      <div className="relative flex items-center justify-center h-10 mt-4">
        ...
        <h1 className='text-4xl font-extrabold dark:text-white'>Butterfly Knife Skins:</h1>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 m-6">
          {filteredGun.map(weapon => (
            <div className="border rounded-lg shadow hover:shadow-md transition duration-200 p-4 bg-white">
              <h3 className="text-lg text-center font-bold overflow-wrap mb-2">{weapon.name}</h3>
              <hr /><br />
