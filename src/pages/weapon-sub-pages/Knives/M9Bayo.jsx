...
const M9Bayo = () => {
  ...
  const filteredGun = weapons.filter(weapon => weapon.weapon.name === "M9 Bayonet Knife");
  ...
  return (
    <>
      <div className="relative flex items-center justify-center h-10 mt-4">
        ...
        <h1 className='text-4xl font-extrabold dark:text-white'>M9 Bayonet Skins:</h1>
      </div>
