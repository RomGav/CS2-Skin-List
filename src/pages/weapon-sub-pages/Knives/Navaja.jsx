...
const Navaja = () => {
  ...
  const filteredGun = weapons.filter(weapon => weapon.weapon.name === "Navaja Knife");
  ...
  return (
    <>
      <div className="relative flex items-center justify-center h-10 mt-4">
        ...
        <h1 className='text-4xl font-extrabold dark:text-white'>Navaja Knife Skins:</h1>
      </div>
