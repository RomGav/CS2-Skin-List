...
const Dualies = () => {
  ...
  const filteredGun = weapons.filter(weapon => weapon.weapon.name === "Dual Berettas");
  ...
  return (
    <>
      <div className="relative flex items-center justify-center h-10 mt-4">
        ...
        <h1 className='text-4xl font-extrabold dark:text-white'>Dual Berettas Skins:</h1>
      </div>
