...
const Bloodhound = () => {
  ...
  const filteredGun = weapons.filter(weapon => weapon.weapon.name === "Bloodhound Gloves");
  ...
  return (
    <>
      <div className="relative flex items-center justify-center h-10 mt-4">
        ...
        <h1 className='text-4xl font-extrabold dark:text-white'>Bloodhound Gloves Skins:</h1>
      </div>
