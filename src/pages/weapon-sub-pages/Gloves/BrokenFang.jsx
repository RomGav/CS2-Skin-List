...
const BrokenFang = () => {
  ...
  const filteredGun = weapons.filter(weapon => weapon.weapon.name === "Broken Fang Gloves");
  ...
  return (
    <>
      <div className="relative flex items-center justify-center h-10 mt-4">
        ...
        <h1 className='text-4xl font-extrabold dark:text-white'>Broken Fang Gloves Skins:</h1>
      </div>
